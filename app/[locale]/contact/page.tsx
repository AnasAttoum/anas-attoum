        ...
        <section className="mt-28!">
            ...
            <div className="grid grid-cols-2 gap-20 items-stretch">
                ...
                <ToAnimation to="bottom" className="relative col-span-2 lg:col-span-1 mx-3 md:mx-10">
                    ...
                    <div className="primaryCircle -top-10 -left-15 " />
                    <div className="primaryCircle top-10 -right-15 " />
                    <div className="primaryCircle bottom-10 -left-15 " />
                    <div className="primaryCircle -bottom-10 -right-15 " />
                </ToAnimation>
